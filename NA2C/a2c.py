# -*- coding: utf-8 -*-
"""
Created on Fri Dec 11 15:54:58 2020
...
class DeepActorCriticAgent(mp.Process):
    def __init__(self, id, env_name, agent_params, env_params):
        """
        Implementación de un agente con la técnica de Advantaje Actor-Critic usando una red neuronal profunda para represntar tanto 
        la politica como la función del valor de aprendizaje
        :param id: Un identificador ID entero para identificar al agente en caso de tener múltiples instancias de agentes
        :param env_name: Nombre o ID del entorno de aprenizaje
        :param agent_params: Parámetros que usarán el agente
        ...
        self.saved_params = False #Saber si tenemos parámetros guardados o no junto con el modelo en la careta pertinente
    ...
    def calculate_n_step_return(self, n_step_rewards, final_state, done, gamma):
        ...
        :param final_state: Estado final tras las n interaciones
        :param done: Variable booleana con valor True si se ha alcanzado el estado final del entorno
        :param gamma: Factor de Descuento para el cáñculo de la diferencia temporal
