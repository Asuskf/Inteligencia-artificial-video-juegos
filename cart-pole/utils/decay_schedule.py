...
class LinearDecaySchedule(object):
    def __init__(self, initial_value, final_value, max_steps):
        assert initial_value > final_value, "El valor inicial debe ser extrictamente mayor al final"
...
if __name__ == "__main__":
    ...
    epsilons = [linear_schedule(step) for step in range(MAX_NUM_EPISODES * MAX_STEP_PER_EPISODE)]
    plt.plot(epsilons)
    plt.show()